...
import { Grid, Box, Card, CardMedia, CardContent, Typography, Chip, Button, CardActionArea, CircularProgress } from '@mui/material';
...
const Events: React.FC = () => {
  ...
  const fetchEvents = async (cursor: string | null = null) => {
    try {
      setLoading(true);
      const response = await axios.get<EventResponse>(`${process.env.NEXT_PUBLIC_BACKEND_API_URL}/public/events`, {
        params: {
          cursor,
          limit: 8
        }
